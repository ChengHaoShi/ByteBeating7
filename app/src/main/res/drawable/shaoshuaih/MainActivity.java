...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jianting();
        //创建fragment对象
        com.example.shaoyangyang.shaoshuaih.fragment.LogicFragment logicFragment = new com.example.shaoyangyang.shaoshuaih.fragment.LogicFragment();
        com.example.shaoyangyang.shaoshuaih.fragment.OnlineFragment onlineFragment = new com.example.shaoyangyang.shaoshuaih.fragment.OnlineFragment();
        ...
        com.example.shaoyangyang.shaoshuaih.adapter.MusicPagerAdapter musicPagerAdapter = new com.example.shaoyangyang.shaoshuaih.adapter.MusicPagerAdapter(getSupportFragmentManager(), fragmentList);
        //viewPager绑定适配器
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.main_menu_imgv:
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(com.example.shaoyangyang.shaoshuaih.MainActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {

                        Toast.makeText(com.example.shaoyangyang.shaoshuaih.MainActivity.this, "所选择的日期是：" + year + "-" + (month + 1) + "-" + dayOfMonth, Toast.LENGTH_SHORT).show();
            ...
            case R.id.main_search_imgv:
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(com.example.shaoyangyang.shaoshuaih.MainActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        Toast.makeText(com.example.shaoyangyang.shaoshuaih.MainActivity.this, "所选择的时间是：" + hourOfDay + ":" + minute, Toast.LENGTH_SHORT).show();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK || keyCode == KeyEvent.KEYCODE_HOME) {
            ...
            builder.setNegativeButton("不能", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    Toast.makeText(com.example.shaoyangyang.shaoshuaih.MainActivity.this, "且看曼城分分 钟打你脸", Toast.LENGTH_SHORT).show();
